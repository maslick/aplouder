...
Aplouder.prototype.init = function () {
    ...
    var template_html =
        ...
        '        </div>';
    self.inputFileEl.insertAdjacentHTML('afterend', template_html);
    self.inputFileEl.style.width = "0.1px";
    self.inputFileEl.style.height = "0.1px";
    self.inputFileEl.style.opacity = "0";
    self.inputFileEl.style.overflow = "hidden";
    self.inputFileEl.style.position = "absolute";
    self.inputFileEl.style.zIndex = "-1";
    ...
    self.inputFileEl.addEventListener('change', function (e) {
        self.removeGallery();
